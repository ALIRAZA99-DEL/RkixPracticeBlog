...
<html class="no-js" lang="zxx">
  <head>
    ...
    <!-- ThemeFisher Icon -->
    <link rel="stylesheet" href="{{asset('front/plugins/themefisher-fonts/themefisher-fonts.css')}}">
    <!-- Light Box -->
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand logo" href="index.html">
        <img src="{{asset('front/images/logo-yellow.png')}}" alt="">
      </a>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="img-content">
              <img class="img-responsive" src="{{asset('front/images/case-study/case-study-img1.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="case-study-content">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="img-content">
              <img class="img-responsive" src="{{asset('front/images/case-study/case-study-img2.png')}}" alt="">
            </div>
          </div>
          <div class="col-md-6">
            <!-- inner sub-title -->
            ...
            <div class="testimonial-slider">
              <div class="item">
                ...
                <div class="testimonials-area">
                  ...
                  <div class="author">
                    <img src="{{asset('front/images/clients-img1.png0')}}" alt="Clients">
              ...
              <div class="item">
                ...
                <div class="testimonials-area">
                  ...
                  <div class="author">
                    <img src="{{asset('front/images/clients-img1.png')}}" alt="Clients">
                    <h3 class="author-name">Paul Lapkin</h3>
                    <span class="designation">CEO at DeviserWeb</span>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-1.png')}}" alt="Client Logo">
          </div>
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-2.png')}}" alt="Client Logo">
          </div>
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-3.png')}}" alt="Client Logo">
          </div>
        
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-4.png')}}" alt="Client Logo">
          </div>
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-5.png')}}" alt="Client Logo">
          </div>
          <div class="col-md-4 block text-center">
            <img src="{{asset('front/images/clients-logo/client-logo-6.png')}}" alt="Client Logo">
          </div>
        </div><!-- /.End row -->
      </div>
    </div>
  ...
  <section class="team">
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic1.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
              <h4>{{$post->tittle}}</h4>
              <span>Creative Director by {{$post->user->name}}</span>
            ...
            <div class="social-media">
              ...
              <li><a href="#"><i class="tf-ion-social-google-outline" aria-hidden="true">({{count($post->comments)}})</i></a></li>
              <li><a href="#"><i class="fa fa-comment" aria-hidden="true"></i></a></li>
              <li><a href="{{route('like.post', $post->id)}}"><i class="fa fa-thumbs-up" aria-hidden="true">({{count($post->likes)}})</i></a></li>
              
            </div>
            <a href="{{route('comment')}}"class="btn btn-success" style="margin-top: 28px;">Comment Here</a>
          </div>
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic2.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
            <h4>{{$post->tittle}}</h4>
    ...
    <!-- <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic3.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic4.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
              <h4>aurelien salomon</h4>
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic5.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
              <h4>aurelien salomon</h4>
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic6.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
              <h4>aurelien salomon</h4>
    ...
    <div class="col-md-4 col-lg-3 padding-0">
      <div class="team-member">
        <div class="th-mouse-effect">
          <div class="team-img">
            <img src="{{asset('front/images/team/team-pic7.jpg')}}" alt="Team img">
          </div>
          <div class="overlay text-center">
            <div class="content">
              <h4>aurelien salomon</h4>
...
<section class="contact-call-to-action">
  ...
  <div id="map" data-latitude="51.507351" data-longitude="-0.127758"></div>
    ...
    <!-- Parallax -->
    <script src="{{asset('front/plugins/parallax.min.js')}}"></script>
    <!-- Video -->
    <script src="{{asset('front/plugins/jquery.vide.js')}}"></script>
    <!-- google map -->
